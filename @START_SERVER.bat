...
start .\Expansion\beta\arma2oaserver.exe -mod=Expansion\beta;Expansion\beta\expansion;ca;@Civilianhive;@dayz_civilian -name=cfgdayz -config=cfgdayz\server.cfg -cfg=cfgdayz\arma2.cfg -profiles=cfgdayz -cpuCount=4 
.\MySQL\cecho {0A}	OK.{07} 
echo.
echo.
echo.

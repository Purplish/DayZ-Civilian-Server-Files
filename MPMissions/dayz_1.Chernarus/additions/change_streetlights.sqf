...
_objHouse = nearestObjects [player, ["House"], 1600]; //EDITABLE - Change distance, (in metres) from the player, at which houses have their lights switched on.
...
_switchpercent = 100;//EDITABLE - Percentage for reliability of power supply. eg. 65 will be 65% chance of lights coming on in each house and 35% chance that lights will fail and flicker off.
